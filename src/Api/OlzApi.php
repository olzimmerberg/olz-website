...
class OlzApi extends Api {
    public function __construct(
        OlzApps $olz_apps,
        \Olz\Common\Endpoints\OnContinuouslyEndpoint $onContinuouslyEndpoint,
        \Olz\Common\Endpoints\LoginEndpoint $loginEndpoint,
        \Olz\Common\Endpoints\ResetPasswordEndpoint $resetPasswordEndpoint,
        \Olz\Common\Endpoints\SwitchUserEndpoint $switchUserEndpoint,
        \Olz\Common\Endpoints\LogoutEndpoint $logoutEndpoint,
        \Olz\Common\Endpoints\GetAuthenticatedUserEndpoint $getAuthenticatedUserEndpoint,
        \Olz\Common\Endpoints\GetAuthenticatedRolesEndpoint $getAuthenticatedRolesEndpoint,
        \Olz\Common\Endpoints\GetEntitiesAroundPositionEndpoint $getEntitiesAroundPositionEndpoint,
        \Olz\Common\Endpoints\VerifyUserEmailEndpoint $verifyUserEmailEndpoint,
        \Olz\Common\Endpoints\UpdateUserPasswordEndpoint $updateUserPasswordEndpoint,
        \Olz\Common\Endpoints\ExecuteEmailReactionEndpoint $executeEmailReactionEndpoint,
        \Olz\Common\Endpoints\LinkStravaEndpoint $linkStravaEndpoint,
        \Olz\Common\Endpoints\LinkTelegramEndpoint $linkTelegramEndpoint,
        \Olz\Common\Endpoints\OnTelegramEndpoint $onTelegramEndpoint,
        \Olz\Common\Endpoints\StartUploadEndpoint $startUploadEndpoint,
        \Olz\Common\Endpoints\UpdateUploadEndpoint $updateUploadEndpoint,
        \Olz\Common\Endpoints\FinishUploadEndpoint $finishUploadEndpoint,
        \Olz\Common\Endpoints\SearchEntitiesEndpoint $searchEntitiesEndpoint,
