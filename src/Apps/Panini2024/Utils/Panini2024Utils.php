...
class Panini2024Utils {
    ...
    private function getOlzPageXY(int $index): array {
        ...
        $olz = [
            ...
            [2, $a4_wid * 0.75, 10.5 + 44 + 10.5 + 64 + 10.5 + 64 + 10.5 + 22],
        ];
        return $olz[$index];
    }
    ...
    private function getDressesPageXY(int $index): array {
        ...
        $olz = [
            ...
            [1, $a4_wid * 0.75, 10.5 + 44 + 2 + 22],
            [1, $a4_wid * 0.25, 10.5 + 44 + 2 + 44 + 2 + 22],
            [1, $a4_wid * 0.75, 10.5 + 44 + 2 + 44 + 2 + 44 + 2 + 22],
            [1, $a4_wid * 0.25, 10.5 + 44 + 2 + 44 + 2 + 44 + 2 + 44 + 2 + 22],
            [1, $a4_wid * 0.75, 10.5 + 44 + 2 + 44 + 2 + 44 + 2 + 44 + 2 + 44 + 2 + 22],
        ];
        return $olz[$index];
    }
