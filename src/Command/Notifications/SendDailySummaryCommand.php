...
#[AsCommand(name: 'olz:send-daily-summary')]
class SendDailySummaryCommand extends BaseSendNotificationsCommand {
    use WithUtilsTrait;
    ...
    public function getNotificationSubscriptionType(): string {
        return NotificationSubscription::TYPE_DAILY_SUMMARY;
    }
