...
#[AsCommand(name: 'olz:send-deadline-warning')]
class SendDeadlineWarningCommand extends BaseSendNotificationsCommand {
    use WithUtilsTrait;

    public function getNotificationSubscriptionType(): string {
        return NotificationSubscription::TYPE_DEADLINE_WARNING;
    }
