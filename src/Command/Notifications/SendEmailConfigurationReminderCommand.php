...
#[AsCommand(name: 'olz:send-email-config-reminder')]
class SendEmailConfigurationReminderCommand extends BaseSendNotificationsCommand {
    use WithUtilsTrait;
    ...
    public function autogenerateSubscriptions(): void {
        $this->log()->info("Generating email configuration reminder subscriptions...");
