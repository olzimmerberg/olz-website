...
#[AsCommand(name: 'olz:send-role-reminder')]
class SendRoleReminderCommand extends BaseSendNotificationsCommand {
    use WithUtilsTrait;
    ...
    public function autogenerateSubscriptions(): void {
        $this->log()->info("Generating role reminder subscriptions...");
