...
#[AsCommand(name: 'olz:send-weekly-preview')]
class SendWeeklyPreviewCommand extends BaseSendNotificationsCommand {
    use WithUtilsTrait;

    public function getNotificationSubscriptionType(): string {
        return NotificationSubscription::TYPE_WEEKLY_PREVIEW;
    }
