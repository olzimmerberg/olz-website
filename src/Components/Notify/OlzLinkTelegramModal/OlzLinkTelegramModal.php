...
class OlzLinkTelegramModal extends OlzComponent {
    public function getHtml($args = []): string {
        ...
        $install_instructions = [
            ...
            "<li><span class='chat-link-wait'>Bitte warten...</span><span class='chat-link-ready'>Öffne <a href='#' rel='noopener noreferrer' target='_blank' id='telegram-chat-link-desktop'>deinen persönlichen OLZ-Info-Chat</a></span></li>",
        ...
        if ($user_agent_utils->isAndroidDevice() || $user_agent_utils->isIOsDevice()) {
            $install_instructions = [
                ...
                "<li><span class='chat-link-wait'>Bitte warten...</span><span class='chat-link-ready'>Öffne <a href='#' rel='noopener noreferrer' target='_blank' id='telegram-chat-link-mobile'>deinen persönlichen OLZ-Info-Chat</a></span></li>",
