...
class OlzTrophy extends OlzComponent {
    ...
    public function getHtml($args = []): string {
        ...
        $etappen = [
            ...
            ["Mittwoch, 28.05.2024", "Starts: 18:00 &ndash; 19:30", "Halbinsel Au", "Schulhaus Steinacher", 691080, 233250,
                "?",
                "?",
                "Keine, im Freien; WC vorhanden (?)",
                false,
            ...
            ["Dienstag, 03.07.2024", "Starts: 17:00 &ndash; 19:00", "Klöntal GL, Saggberg", "Zeltplatz", 719021, 210110,
                "?",
                "?",
                "Keine, im Freien; WC vorhanden (?)",
                false,
            ...
            ["Mittwoch, 17.09.2024", "Starts: 18:00 &ndash; 19:30", "Adliswil", "Schulhaus Werd", 682345, 241122,
                "?",
                "?",
                "Keine, im Freien; WC vorhanden (?)",
                false,
