...
class OlzTrophy extends OlzComponent {
    public static string $title = "Trophy";
    public static string $description = "Orientierungslauf-Mini-Wettkämpfe, offen für Alle, in den Dörfern und Städten unseres Vereinsgebiets organisiert durch die OL Zimmerberg.";
