...
class OlzTermineListsTile extends AbstractOlzTile {
    ...
    public function getHtml(mixed $args): string {
        $this->termineFilterUtils()->loadTypeOptions();
    ...
    protected function renderAllUpcomingList(): string {
        ...
        $filter = $this->termineFilterUtils()->getDefaultFilter();
        $filter['typ'] = 'alle';
    ...
    protected function getNumberOfEntries(array $filter): int {
        $date_filter = $this->termineFilterUtils()->getSqlDateRangeFilter($filter, 'c');
        $type_filter = $this->termineFilterUtils()->getSqlTypeFilter($filter, 'c');
