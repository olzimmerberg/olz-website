    ...
    public static function render(): string {
        ...
        if ($latest_weekly_picture) {
            ...
            if (!$alternative_image_id) {
                $out .= $image_utils->olzImage($db_table, $id, $image_id, 256);
            } else {
                $out .= "<span onmouseover='olz.olzWeeklyPictureTileSwap()' onclick='olz.olzWeeklyPictureTileSwap()' id='olz-weekly-image'>".$image_utils->olzImage($db_table, $id, $image_id, 256)."</span><span onmouseout='olz.olzWeeklyPictureTileUnswap()' onclick='olz.olzWeeklyPictureTileUnswap()' id='olz-weekly-alternative-image'>".$image_utils->olzImage($db_table, $id, $alternative_image_id, 256)."</span>";
            }
