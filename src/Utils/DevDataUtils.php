...
class DevDataUtils {
    ...
    public function addFiles() {
        ...
        $this->mkdir("{$data_path}img/galerie/3/thumb");
        $this->mkimg("{$sample_path}sample-picture.jpg", $data_path, "img/galerie/3/thumb/001.jpg", 120, 80);
        ...
        $this->mkdir("{$data_path}img/galerie/6/thumb");
        $this->mkimg("{$sample_path}sample-picture.jpg", $data_path, "img/galerie/6/thumb/001.jpg", 120, 80);
        $this->mkimg("{$sample_path}sample-picture.jpg", $data_path, "img/galerie/6/thumb/002.jpg", 120, 80);
        $this->mkimg("{$sample_path}sample-picture.jpg", $data_path, "img/galerie/6/thumb/003.jpg", 120, 80);
        $this->mkimg("{$sample_path}sample-picture.jpg", $data_path, "img/galerie/6/thumb/004.jpg", 120, 80);
