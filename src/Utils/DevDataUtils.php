...
class DevDataUtils {
    ...
    public function addFiles(): void {
        ...
        $this->mkimg("{$sample_path}sample-picture.jpg", $data_path, "img/weekly_picture/1/img/ed48ksmyjVgRsaKXUXmmcbRN.jpg", 800, 600);
        $this->mkdir("{$data_path}img/weekly_picture/2");
        $this->mkdir("{$data_path}img/weekly_picture/2/img");
        $this->mkimg("{$sample_path}sample-picture.jpg", $data_path, "img/weekly_picture/2/img/C8k84ncvWyVptk6kjtMJxTUu.jpg", 800, 600);
        ...
        $this->mkimg("{$sample_path}sample-picture.jpg", $data_path, "img/news/1203/thumb/MIGRATED0000000012030001.jpg\$128.jpg", 128, 96);
        ...
        $this->mkimg("{$sample_path}sample-picture.jpg", $data_path, "img/news/1206/thumb/MIGRATED0000000012060001.jpg\$128.jpg", 128, 96);
        $this->mkimg("{$sample_path}sample-picture.jpg", $data_path, "img/news/1206/thumb/MIGRATED0000000012060002.jpg\$128.jpg", 128, 96);
        $this->mkimg("{$sample_path}sample-picture.jpg", $data_path, "img/news/1206/thumb/MIGRATED0000000012060003.jpg\$128.jpg", 128, 96);
        $this->mkimg("{$sample_path}sample-picture.jpg", $data_path, "img/news/1206/thumb/MIGRATED0000000012060004.jpg\$128.jpg", 128, 96);
        ...
        $this->mkdir("{$data_path}img/snippets/14");
        $this->mkdir("{$data_path}img/snippets/14/img");
        $this->mkimg("{$sample_path}sample-picture.jpg", $data_path, "img/snippets/14/img/myjGV7ADStN8rITm5OSy9c48.jpg", 800, 800);
        ...
        $this->mkdir("{$data_path}img/termine/10");
        $this->mkdir("{$data_path}img/termine/10/img");
        $this->mkimg("{$sample_path}sample-picture.jpg", $data_path, "img/termine/10/img/659gCbqzigX8D37XgWMbedB3.jpg", 800, 600);
        $this->mkdir("{$data_path}img/termine/13");
        $this->mkdir("{$data_path}img/termine/13/img");
        $this->mkimg("{$sample_path}sample-picture.jpg", $data_path, "img/termine/13/img/8EKYh2n8DZWShYMWo9ZRnor5.jpg", 800, 600);
        ...
        $this->mkdir("{$data_path}img/termin_templates/2");
        $this->mkdir("{$data_path}img/termin_templates/2/img");
        $this->mkimg("{$sample_path}sample-picture.jpg", $data_path, "img/termin_templates/2/img/bv3KeYVKDJNg3MTyjhSQsDRx.jpg", 800, 600);
