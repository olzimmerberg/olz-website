...
<div style='position:relative; height:160px; padding:0px; background-image:url(icns/headerbg.png); background-repeat:repeat-x; overflow-x:auto; overflow-y:hidden;'><img src='icns/olzschatten.".$bildart."' alt='' style='float:left; margin-top:10px;' class='noborder'><div style='position:relative; height:140px; overflow:hidden;'>";
include "header.php";
echo "</div></div>
