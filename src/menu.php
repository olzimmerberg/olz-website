...
$fontsize = "16";
$menu = array(
array("Startseite","1",$fontsize), // Menüpunkt ('Name','Link')
array("","",1),
array("Aktuell","2",$fontsize),
array("Leistungssport","7",$fontsize),
array("Termine","3",$fontsize),
array("","",1),
array("Galerie","4",$fontsize),
array("Forum","5",$fontsize),
array("Karten","12",$fontsize),
array("","",1),
array("Material & Kleider","21",$fontsize),
array("Service","8",$fontsize),
//array("Anmeldungen","13",15),
array("Kontakt","6",$fontsize),
array("","",1),
);
...
if (in_array('ftp',preg_split("/ /",$_SESSION['auth'])) OR ($_SESSION['auth'] == 'all'))
    {array_push($menu,array("WebFTP","ftp",11));
    }
if ($_SESSION['auth'] == 'all')
    {array_push($menu,array("Online-Resultate","16",11));
    }
if ($_SESSION['auth'] == 'all')
    {array_push($menu,array("SVG-Editor","17",11));
    }
if (isset($_SESSION["auth"]))
    {array_push($menu,array("Logout","Logout",11));
    }
else
    {array_push($menu,array("Admin","10",11));
    }
