...
// EINSTELLUNGEN
//-------------------------------------------
$spalten = array(array('rang',5),array('name',40),array('jg',5),array('club',35),array('zeit',15)); // Spalten und Spaltenbreite in %
...
if(empty($temp)) echo "<div style='margin-left:10px;'>Es sind noch keine Resultate verfügbar.<br>Die Resultate können am Lauftag auf dieser Internetseite oder auf <a href='http://www.compass-zos.ch/resultate/resultate_2_nat_ol_2019.html' target='_blank' class='linkext'>compass-zos.ch</a> eingesehen werden.</div>";
else echo "<div class='titel' style='margin:10px 0px 10px 0px;'>Kategorien<a href='zol/zol_index.php?event=zol_190512' class='linkint' style='vertical-align:baseline;'>Mobile-Version</a></div>";
