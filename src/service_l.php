...
if (($db_edit == "0") or ($do == "vorschau")) {
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        if ($zugriff and ($do != 'vorschau')) {
            $edit_admin = "<a href='index.php?id={$id_tmp}&amp;{$button_name}=up' style='margin-right:4px;'><img src='icns/up.gif' class='noborder'></a><a href='index.php?id={$id_tmp}&amp;{$button_name}=down' style='margin-right:4px;'><img src='icns/down.gif' class='noborder'></a><a href='index.php?id={$id_tmp}&{$button_name}=start' class='linkedit'>&nbsp;</a>";
        } else {
            $edit_admin = "";
        }
