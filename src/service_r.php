...
<?php
$db_table = "newsletter";
$kategorien = array(array('aktuell','Neuen Nachrichten',''),array('forum','Neuen Forumsbeiträgen',''),array('termine','Wichtige Termine (z.B. Meldeschluss)',''),array('vorstand','Vorstandsmitteilungen','1'));
