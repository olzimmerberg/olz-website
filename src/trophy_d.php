...
$etappen = [
    ...
    ["Mittwoch, 26.08.2020", "<b>Online-Anmeldung erforderlich</b>, Starts: 18:00 &ndash; 19:30", "Kopfholz", "Schulhaus Chopfholz", 682760, 240270,
        ...
        5790,
        "<a href='https://forms.gle/ixS1ZD22PmbdeYcy6' class='linkext'>Online-Anmeldung</a><br><a href='https://docs.google.com/spreadsheets/d/12t6VLXz4s7VXxwgojn80El3QaLdP5awg5FHzqslLLm4/edit?usp=sharing' class='linkext'>Startliste</a>",
    ],
];
...
for ($i = 0; $i < count($etappen); $i++) {
    ...
    <tr><td></td><td><a href='{$code_href}results/?file=".$etappe[12].".xml' class='linkint'>Resultate</a>" : "")."</td></tr>
