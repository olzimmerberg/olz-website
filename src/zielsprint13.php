...
if ($_SESSION["auth"] == "all") {
    ...
    for ($i = 0; $i < $num_l; $i++) {
        ...
        for ($j = 0; $j < $num_r; $j++) {
            ...
            array_push($wertung[$row_r["person"]], [$row_l["id"], $cmpscore, $laufzeit, $siegerlaufzeit, $abgefedertelaufzeit, $zieleinlaufzeit, $leistungskm, $score, intval($row_r["letzterposten"])]);
        }
    }
...
<table style='width:auto;'><tr><td style='vertical-align:middle; width:100px; text-align:right;'>=&nbsp;</td><td style='text-align:center;'>".number_format($endscore, 2, ".", "'")."</td></tr></table>
        ...
        array_push($rangliste, [$people[$i], $endscore]);
    }
