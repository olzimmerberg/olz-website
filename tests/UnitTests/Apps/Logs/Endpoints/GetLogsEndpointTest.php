...
final class GetLogsEndpointTest extends UnitTestCase {
    public function testGetLogsEndpointTargetDate(): void {
        ...
        $this->assertSame([
            ...
            'DEBUG Create new index private-path/logs/merged-2020-03-13.log.index.json.gz',
            'DEBUG log_file_before private-path/logs/merged-2020-03-12.log.gz',
            'DEBUG Create new index private-path/logs/merged-2020-03-12.log.index.json.gz',
            'DEBUG log_file_after private-path/logs/merged-2020-03-14.log',
            'DEBUG Create new index private-path/logs/merged-2020-03-14.log.index.json.gz',
