...
final class SyncSolvEventsCommandTest extends UnitTestCase {
    public function testSyncSolvEventsCommand(): void {
        ...
        $this->assertSame([
            ...
            'INFO INSERTED 20203',
            'WARNING Update termin 12 from SOLV: no SOLV ID.',
            'WARNING Update termin 123 from SOLV: no SOLV ID.',
            'WARNING Update termin 1234 from SOLV: SOLV ID mismatch (11012 vs. 20202).',
            'INFO UPDATED 20202',
            'INFO DELETED 20201',
