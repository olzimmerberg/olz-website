...
use Olz\Common\Endpoints\SearchEntitiesEndpoint;
 ...
 * @internal
 *
 * @covers \Olz\Common\Endpoints\SearchEntitiesEndpoint
 */
final class SearchEntitiesEndpointTest extends UnitTestCase {
    ...
    public function testSearchEntitiesEndpointWithInvalidFilter(): void {
        ...
        try {
            ...
            $this->assertSame([
                "INFO Valid user request",
                "NOTICE HTTP error 400 Invalid filter invalidFilter => invalid for entity TerminLocation: No such TerminLocation filter: invalidFilter",
            ], $this->getLogs());
        }
    }
