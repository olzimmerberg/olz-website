...
final class SolvEventParserTest extends UnitTestCase {
    ...
    public function testParseFixtures2006(): void {
        ...
        $this->assertSame(0, $first_solv_event_2006->getCoordX());
        $this->assertSame(0, $first_solv_event_2006->getCoordY());
    ...
    public function testParseFixtures2018(): void {
        ...
        $this->assertSame(0, $first_solv_event_2018->getCoordX());
        $this->assertSame(0, $first_solv_event_2018->getCoordY());
