...
use Olz\Termine\Endpoints\CreateTerminNotificationTemplateEndpoint;
 ...
 * @internal
 *
 * @covers \Olz\Termine\Endpoints\CreateTerminNotificationTemplateEndpoint
 */
final class CreateTerminNotificationTemplateEndpointTest extends UnitTestCase {
    ...
    public function testCreateTerminNotificationTemplateEndpointNoAccess(): void {
        WithUtilsCache::get('authUtils')->has_permission_by_query = ['termine' => false];
        $endpoint = new CreateTerminNotificationTemplateEndpoint();
    ...
    public function testCreateTerminNotificationTemplateEndpoint(): void {
