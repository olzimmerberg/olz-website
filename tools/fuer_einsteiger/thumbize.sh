...
thumbize () {
    ...
    magick "./img/$IDENT.jpg" -resize "$WIDTH^" -gravity center -crop $CROP_SMALL +repage "./thumb/$IDENT.jpg"
    magick "./img/$IDENT.jpg" -resize "$TWO_WIDTHS^" -gravity center -crop $CROP_BIG +repage "./thumb/$IDENT@2x.jpg"
}
